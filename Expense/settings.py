...
SECRET_KEY = 'django-insecure-6f$84vpg7$s+u+-^1hw^5f4+@13l94)qr%)7xn19uh#gl%xsqr'
...
# MEDIA_ROOT = str(BASE_DIR / 'public/static')
...
STATICFILES_DIRS = [str(BASE_DIR / 'public/static')]  # Additional static file directories
